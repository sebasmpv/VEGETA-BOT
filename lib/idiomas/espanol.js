const lenguaje = () => { return 'es' } //Español xd

//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `❱❱ 𝙀𝙇𝙄𝙏𝙀 𝘽𝙊𝙏 𝙂𝙇𝙊𝘽𝘼𝙇 ❰❰\n\n` } 
const smsAvisoAG = () => { return `❱❱ 𝙄𝙉𝙁𝙊𝙍𝙈𝘼𝘾𝙄𝙊́𝙉 ❰❰\n\n` }
const smsAvisoIIG = () => { return `❱❱ 𝙄𝙉𝙁𝙊𝙍𝙈𝘼𝘾𝙄𝙊́𝙉 ❰❰\n\n` }
const smsAvisoFG = () => { return `❱❱ 𝙀𝙍𝙍𝙊𝙍 ❰❰\n\n` }
const smsAvisoMG = () => { return `❱❱ 𝘼𝘾𝘾𝙄𝙊́𝙉 𝙈𝘼𝙇 𝙐𝙎𝘼𝘿𝘼 ❰❰\n\n` }
const smsAvisoEEG = () => { return `❱❱ 𝙍𝙀𝙋𝙊𝙍𝙏𝙀́ ❰❰\n\n` }
const smsAvisoEG = () => { return `❱❱ 𝙀𝙇𝙄𝙏𝙀 𝘽𝙊𝙏 𝙂𝙇𝙊𝘽𝘼𝙇 ❰❰\n\n` }

//PARÁMETROS EN COMANDOS
const smsRowner = () => { return `\`\`\`» 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙢𝙞 𝙘𝙧𝙚𝙖𝙙𝙤𝙧 𝙆𝙚𝙫𝙫 𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧.\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`» 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙢𝙞 𝙘𝙧𝙚𝙖𝙙𝙤𝙧 𝙆𝙚𝙫𝙫 𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧.\`\`\`` }//OWNER
...
const smsAdmin = () => { return `\`\`\`» 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙚𝙨 𝙨𝙤𝙡𝙤 𝙥𝙖𝙧𝙖 𝙖𝙙𝙢𝙞𝙣𝙞𝙨𝙩𝙧𝙖𝙙𝙤𝙧𝙚𝙨 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤.\`\`\`` }//ADMINS
const smsBotAdmin = () => { return `\`\`\`» 𝙉𝙚𝙘𝙚𝙨𝙞𝙩𝙤 𝙨𝙚𝙧 𝙖𝙙𝙢𝙞𝙣𝙞𝙨𝙩𝙧𝙖𝙙𝙤𝙧 𝙙𝙚 𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤 𝙥𝙖𝙧𝙖 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\`\`\`` }//BOT CON ADMIN
...
*╟* *-1* 𝑰𝑵𝑺𝑬𝑹𝑽𝑰𝑩𝑳𝑬 💩
*╟👤@user* 
*╟*💥𝑬𝑺𝑪𝑼𝑷𝑨𝑵𝑳𝑬 𝑬𝑵 𝑬𝑺𝑨 𝑪𝑨𝑹𝑨
 𝑷𝑶𝑹 𝑨𝑫𝑶𝑹𝑵𝑶 𝑬𝑵 𝑬𝑳 𝑮𝑹𝑼𝑷𝑶.
*╚══════════════*`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝙀𝙡𝙞𝙩𝙚 𝘽𝙤𝙩 𝙂𝙡𝙤𝙗𝙖𝙡 '} 
const smsApagar = () => { return '𝘿𝙀𝙎𝘼𝘾𝙏𝙄𝙑𝘼𝘿𝙊'} 
const smsEncender = () => { return '𝘼𝘾𝙏𝙄𝙑𝘼𝘿𝙊'} 
...
const smsMens1 = () => { return `𝙁𝙐𝙉𝘾𝙄𝙊́𝙉`} 
const smsMens2 = () => { return `𝙀𝙎𝙏𝘼𝘿𝙊`} 
const smsMens3 = () => { return `𝙀𝙉 𝙀𝙎𝙏𝙀`} 
const smsMens4 = () => { return `𝘽𝙊𝙏`} 
const smsMens5 = () => { return `𝙂𝙍𝙐𝙋𝙊`} 
...
//_antiviewonce.js
const smsAntiView = () => { return `𝙀𝙡𝙞𝙩𝙚 𝘽𝙤𝙩 𝙂𝙡𝙤𝙗𝙖𝙡 𝙩𝙤𝙙𝙤 𝙡𝙤 𝙫𝙚 𝙢𝙞 𝙥𝙖𝙣𝙖.`} 
...
//grupo-tagall.js
const smstagaa = () => { return `𝘼𝘾𝙏𝙄𝙑𝙀𝙉𝙎𝙀𝙉 乂`}
...
//jadibot-serbot.js
const smsIniJadi = () => { return `¡𝗛𝗼𝗹𝗮 𝗵𝘂𝗺𝗮𝗻𝗼! 👋🏻 

Introduzca el código QR en vincular dispositivos. 
